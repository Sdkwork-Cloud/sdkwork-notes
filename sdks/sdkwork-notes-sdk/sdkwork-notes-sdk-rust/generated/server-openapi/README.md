...
```bash
cargo add sdkwork-notes-sdk-generated
```

## Quick Start

```rust
use sdkwork_notes_sdk_generated::{SdkworkCustomClient, SdkworkConfig};
use std::collections::HashMap;


#[tokio::main]
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    let client = SdkworkCustomClient::new(SdkworkConfig::new("/notes/v3/api"))?;
