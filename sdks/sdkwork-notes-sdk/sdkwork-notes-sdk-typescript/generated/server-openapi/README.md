...
```bash
npm install @sdkwork-internal/notes-sdk-generated
# or
yarn add @sdkwork-internal/notes-sdk-generated
# or
pnpm add @sdkwork-internal/notes-sdk-generated
```

## Quick Start

```typescript
import { SdkworkCustomClient } from '@sdkwork-internal/notes-sdk-generated';

const client = new SdkworkCustomClient({
  baseUrl: '/notes/v3/api',
  timeout: 30000,
});
...
```typescript
import { SdkworkCustomClient, NetworkError, TimeoutError, AuthenticationError } from '@sdkwork-internal/notes-sdk-generated';
