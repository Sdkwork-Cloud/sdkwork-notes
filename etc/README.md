# sdkwork-notes Source Configuration
...
| `appId` | `sdkwork-notes` |
| `runtimeCode` | `notes` |
| Config root | `/etc/sdkwork/notes/` |
| Runtime TOML | `/etc/sdkwork/notes/config.toml` |
| Secrets | `/etc/sdkwork/notes/secrets/` |
| Override | `SDKWORK_NOTES_CONFIG_FILE` |
