...
pub fn notes_app_public_path_prefixes() -> Vec<String> {
...
pub fn wrap_router_with_web_framework(
    ...
    route_manifest
        .validate_public_path_prefixes(&notes_app_public_path_prefixes())
        .expect("notes app-api public prefixes must not cover protected manifest routes");

    let layer = WebFrameworkLayer::new(resolver)
        .with_profile(WebRequestContextProfile {
            public_path_prefixes: notes_app_public_path_prefixes(),
