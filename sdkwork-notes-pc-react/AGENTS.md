...
- Local directories to inspect first when relevant: `contracts/`, `packages/`, `scripts/`, `specs/`, `src/`.
...
- `pnpm run test:app`: run the configured test suite for this scope.
- `pnpm run test:desktop:contracts`: run the configured test suite for this scope.
- `pnpm run test:desktop:rust`: run the configured test suite for this scope.
- `pnpm run test:workspace:contracts`: run the configured test suite for this scope.
