# SDKWork Notes Notes Component Specs

This directory is the local standards index for `@sdkwork/notes-pc-notes`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/notes-pc-notes` |
| Type | `react-package` |
| Root | `sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-pc-notes` |
| Domain | `content` |
| Capability | `notes` |
...
- `pnpm --filter @sdkwork/notes-pc-notes typecheck`
