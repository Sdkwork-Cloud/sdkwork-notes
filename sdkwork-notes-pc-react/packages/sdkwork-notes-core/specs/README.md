...
This directory is the local standards index for `@sdkwork/notes-core`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/notes-core` |
| Type | `react-package` |
| Root | `sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-core` |
| Domain | `content` |
| Capability | `notes` |
...
- `pnpm --filter @sdkwork/notes-core typecheck`
