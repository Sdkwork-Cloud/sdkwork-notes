...
This directory is the local standards index for `@sdkwork/notes-search`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/notes-search` |
| Type | `node-package` |
| Root | `sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-search` |
| Domain | `content` |
| Capability | `notes` |
...
- `pnpm --filter @sdkwork/notes-search typecheck`
