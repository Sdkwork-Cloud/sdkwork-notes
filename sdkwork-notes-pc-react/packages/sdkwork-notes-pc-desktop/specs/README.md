...
This directory is the local standards index for `@sdkwork/notes-pc-desktop`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/notes-pc-desktop` |
| Type | `react-tauri-package` |
| Root | `sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-pc-desktop` |
| Domain | `content` |
| Capability | `notes` |
...
- `pnpm --filter @sdkwork/notes-pc-desktop typecheck`
