# SDKWork Notes Desktop Component Specs

This directory is the local standards index for `sdkwork-notes-desktop`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-notes-desktop` |
| Type | `tauri-host` |
| Root | `sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-pc-desktop/src-tauri` |
| Domain | `content` |
| Capability | `notes` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-pc-desktop/src-tauri/Cargo.toml`
