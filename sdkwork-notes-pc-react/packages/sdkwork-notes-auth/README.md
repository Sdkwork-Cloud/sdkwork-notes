...
This README is the SDKWork module entrypoint for `@sdkwork/notes-auth`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../sdkwork-specs/`.
