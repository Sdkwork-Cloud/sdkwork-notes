...
This directory is the local standards index for `@sdkwork/notes-auth`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/notes-auth` |
| Type | `react-package` |
| Root | `sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-auth` |
| Domain | `iam` |
| Capability | `auth` |
...
- `pnpm --filter @sdkwork/notes-auth typecheck`
