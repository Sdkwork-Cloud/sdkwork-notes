# SDKWork Notes Observability Component Specs

This directory is the local standards index for `@sdkwork/notes-pc-observability`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/notes-pc-observability` |
| Type | `node-package` |
| Root | `sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-pc-observability` |
| Domain | `content` |
| Capability | `notes` |
...
- `pnpm --filter @sdkwork/notes-pc-observability typecheck`
