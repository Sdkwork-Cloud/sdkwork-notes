  ...
  return (
    <button
      ...
      className={`rounded-2xl border px-4 py-3 text-left text-sm font-medium transition ${
        active
          ? 'border-primary-400 bg-primary-50 text-primary-700 dark:bg-primary-500/10 dark:text-primary-200'
      ...
      <SurfaceCard>
        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex items-center gap-4">
            <div className="flex h-16 w-16 items-center justify-center rounded-3xl bg-primary-100 text-primary-700 dark:bg-primary-500/10 dark:text-primary-200">
              ...
              {themeColors.map((value) => (
                ...
                >
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <span
                      className="inline-flex h-4 w-10 rounded-full border border-white/40 shadow-sm"
                      style={{
