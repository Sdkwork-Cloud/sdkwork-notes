...
This directory is the local standards index for `@sdkwork/notes-user`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/notes-user` |
| Type | `react-package` |
| Root | `sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-user` |
| Domain | `iam` |
| Capability | `user` |
...
- `pnpm --filter @sdkwork/notes-user typecheck`
