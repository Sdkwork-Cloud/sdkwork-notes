# SDKWork Notes Auth Component Specs

This directory is the local standards index for `@sdkwork/notes-pc-auth`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/notes-pc-auth` |
| Type | `react-package` |
| Root | `sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-pc-auth` |
| Domain | `iam` |
| Capability | `auth` |
...
- `pnpm --filter @sdkwork/notes-pc-auth typecheck`
