...
This directory is the local standards index for `@sdkwork/notes-commons`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/notes-commons` |
| Type | `react-package` |
| Root | `sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-commons` |
| Domain | `content` |
| Capability | `notes` |
...
- `pnpm --filter @sdkwork/notes-commons typecheck`
