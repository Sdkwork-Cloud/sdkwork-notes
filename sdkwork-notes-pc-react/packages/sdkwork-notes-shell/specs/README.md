...
This directory is the local standards index for `@sdkwork/notes-shell`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/notes-shell` |
| Type | `react-package` |
| Root | `sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-shell` |
| Domain | `content` |
| Capability | `notes` |
...
- `pnpm --filter @sdkwork/notes-shell typecheck`
