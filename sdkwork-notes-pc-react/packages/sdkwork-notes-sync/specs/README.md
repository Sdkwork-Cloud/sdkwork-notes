...
This directory is the local standards index for `@sdkwork/notes-sync`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/notes-sync` |
| Type | `node-package` |
| Root | `sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-sync` |
| Domain | `content` |
| Capability | `notes` |
