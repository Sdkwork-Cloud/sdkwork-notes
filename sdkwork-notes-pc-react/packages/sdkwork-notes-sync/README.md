...
This README is the SDKWork module entrypoint for `@sdkwork/notes-sync`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../sdkwork-specs/`.
...
- `pnpm --filter @sdkwork/notes-sync typecheck`
