...
| Type | `tauri-host` |
| Root | `sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-desktop/src-tauri` |
| Domain | `content` |
| Capability | `notes` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-desktop/src-tauri/Cargo.toml`
