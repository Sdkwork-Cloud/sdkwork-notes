# SDKWork Notes Core Component Specs

This directory is the local standards index for `@sdkwork/notes-pc-core`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/notes-pc-core` |
| Type | `react-package` |
| Root | `sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-pc-core` |
| Domain | `content` |
| Capability | `notes` |
...
- `pnpm --filter @sdkwork/notes-pc-core typecheck`
