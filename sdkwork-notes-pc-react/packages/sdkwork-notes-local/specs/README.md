...
This directory is the local standards index for `@sdkwork/notes-local`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/notes-local` |
| Type | `node-package` |
| Root | `sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-local` |
| Domain | `content` |
| Capability | `notes` |
...
- `pnpm --filter @sdkwork/notes-local typecheck`
