...
This directory is the local standards index for `@sdkwork/notes-notes`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/notes-notes` |
| Type | `react-package` |
| Root | `sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-notes` |
| Domain | `content` |
| Capability | `notes` |
...
- `pnpm --filter @sdkwork/notes-notes typecheck`
