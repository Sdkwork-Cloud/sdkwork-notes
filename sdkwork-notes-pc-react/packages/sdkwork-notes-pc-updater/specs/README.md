# SDKWork Notes Updater Component Specs

This directory is the local standards index for `@sdkwork/notes-pc-updater`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/notes-pc-updater` |
| Type | `node-package` |
| Root | `sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-pc-updater` |
| Domain | `content` |
| Capability | `notes` |
...
- `pnpm --filter @sdkwork/notes-pc-updater typecheck`
