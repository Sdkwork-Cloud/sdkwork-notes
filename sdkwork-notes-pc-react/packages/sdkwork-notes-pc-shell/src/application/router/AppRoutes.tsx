...
import { AuthOAuthCallbackPage, AuthPage, useAuthStore } from '@sdkwork/notes-pc-auth';
import { useNotesTranslation } from '@sdkwork/notes-pc-i18n';

const NotesWorkspacePage = lazy(async () => ({
  default: (await import('@sdkwork/notes-pc-notes')).NotesWorkspacePage,
}));

const AccountPage = lazy(async () => ({
  default: (await import('@sdkwork/notes-pc-user')).AccountPage,
}));
