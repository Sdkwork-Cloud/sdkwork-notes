# SDKWork Notes Shell Component Specs

This directory is the local standards index for `@sdkwork/notes-pc-shell`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/notes-pc-shell` |
| Type | `react-package` |
| Root | `sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-pc-shell` |
| Domain | `content` |
| Capability | `notes` |
...
- `pnpm --filter @sdkwork/notes-pc-shell typecheck`
