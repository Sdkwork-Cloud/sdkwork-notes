...
This directory is the local standards index for `@sdkwork/notes-observability`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/notes-observability` |
| Type | `node-package` |
| Root | `sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-observability` |
| Domain | `content` |
| Capability | `notes` |
...
- `pnpm --filter @sdkwork/notes-observability typecheck`
