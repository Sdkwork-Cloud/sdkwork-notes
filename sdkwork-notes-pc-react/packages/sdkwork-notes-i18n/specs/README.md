...
This directory is the local standards index for `@sdkwork/notes-i18n`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/notes-i18n` |
| Type | `react-package` |
| Root | `sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-i18n` |
| Domain | `content` |
| Capability | `notes` |
...
- `pnpm --filter @sdkwork/notes-i18n typecheck`
