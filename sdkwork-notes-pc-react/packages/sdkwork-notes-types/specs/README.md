...
This directory is the local standards index for `@sdkwork/notes-types`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/notes-types` |
| Type | `node-package` |
| Root | `sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-types` |
| Domain | `content` |
| Capability | `notes` |
