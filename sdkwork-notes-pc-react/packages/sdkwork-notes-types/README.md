...
This README is the SDKWork module entrypoint for `@sdkwork/notes-types`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../sdkwork-specs/`.
...
- `pnpm --filter @sdkwork/notes-types typecheck`
