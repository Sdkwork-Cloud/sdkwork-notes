# SDKWork Notes User Component Specs

This directory is the local standards index for `@sdkwork/notes-pc-user`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/notes-pc-user` |
| Type | `react-package` |
| Root | `sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-pc-user` |
| Domain | `iam` |
| Capability | `user` |
...
- `pnpm --filter @sdkwork/notes-pc-user typecheck`
