...
This directory is the local standards index for `@sdkwork/notes-updater`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/notes-updater` |
| Type | `node-package` |
| Root | `sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-updater` |
| Domain | `content` |
| Capability | `notes` |
...
- `pnpm --filter @sdkwork/notes-updater typecheck`
