# SDKWork Notes I18n Component Specs

This directory is the local standards index for `@sdkwork/notes-pc-i18n`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/notes-pc-i18n` |
| Type | `react-package` |
| Root | `sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-pc-i18n` |
| Domain | `content` |
| Capability | `notes` |
...
- `pnpm --filter @sdkwork/notes-pc-i18n typecheck`
