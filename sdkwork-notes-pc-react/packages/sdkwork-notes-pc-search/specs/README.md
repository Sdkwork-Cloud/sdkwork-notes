# SDKWork Notes Search Component Specs

This directory is the local standards index for `@sdkwork/notes-pc-search`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/notes-pc-search` |
| Type | `node-package` |
| Root | `sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-pc-search` |
| Domain | `content` |
| Capability | `notes` |
...
- `pnpm --filter @sdkwork/notes-pc-search typecheck`
