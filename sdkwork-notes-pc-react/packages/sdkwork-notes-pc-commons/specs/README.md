# SDKWork Notes Commons Component Specs

This directory is the local standards index for `@sdkwork/notes-pc-commons`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/notes-pc-commons` |
| Type | `react-package` |
| Root | `sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-pc-commons` |
| Domain | `content` |
| Capability | `notes` |
...
- `pnpm --filter @sdkwork/notes-pc-commons typecheck`
