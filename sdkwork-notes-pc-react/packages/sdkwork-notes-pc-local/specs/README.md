# SDKWork Notes Local Component Specs

This directory is the local standards index for `@sdkwork/notes-pc-local`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/notes-pc-local` |
| Type | `node-package` |
| Root | `sdkwork-notes/sdkwork-notes-pc-react/packages/sdkwork-notes-pc-local` |
| Domain | `content` |
| Capability | `notes` |
...
- `pnpm --filter @sdkwork/notes-pc-local typecheck`
