...
const baselinePath = path.join(
  root,
  'database/ddl/baseline/postgres/0001_notes_legacy_baseline.sql',
);
...
const prefixRegistry = {
  ...
  prefixes: [{ prefix: 'notes_', owner: 'notes-platform', domain: 'notes' }],
};
...
process.stdout.write(`materialized ${tableNames.length} tables into notes database contract\n`);
